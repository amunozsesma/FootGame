module.exports = function(http) {
	...
	function onNewUser(socket, data) {
		...
		if (users.length === 2) {
			...
			//TODO generate new state handler/ new SessionHandler so if new user connects, it does a lookup and gives sockets to stat handler
			// State handler will haver the State objects
