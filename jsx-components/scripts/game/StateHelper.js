define(["game/ActionPosibilitiesProvider"], function(Actions) {
	...
	StateHelper.prototype.selectPlayer = function(posX, posY) {

	};

	StateHelper.prototype.setPosibility = function(posX, posY) {

	};

	StateHelper.prototype.setAction = function(action) {

	};

	StateHelper.prototype.clearSelections = function() {
